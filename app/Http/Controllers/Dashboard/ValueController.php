...
class ValueController extends BaseController
{
    ...
    {
        $values = Value::orderBy('id', 'desc')->get();
        return view('dashboard.values.crud', [
            'values'=>$values
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($validatedData['photo'])) {
            $validatedData['photo'] = $this->photoSave($validatedData['photo'], 'image/value');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($validatedData['photo'])) {
            $this->fileDelete('\Value', $id, 'photo');
            $validatedData['photo'] = $this->photoSave($validatedData['photo'], 'image/value');
        }
        Value::find($id)->update($validatedData);
