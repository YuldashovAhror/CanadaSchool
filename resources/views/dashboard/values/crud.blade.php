                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($values as $key => $value)
                                <tr>
                                    <th scope="row">{{ ++$key }}</th>
                                    <td><img src="{{ $value->photo }}" alt="" style="width: 100px; height: 100px;">
                                    </td>
                                    <td>{{ $value->name_ru }}</td>
                                    <td>{{ $value->alt_ru }}</td>
                                    <td>{{ $value->photo_discription_ru }}</td>
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success mb-1" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $value->id }}Edit"><i
                                                class="bx bx-pencil">Изменить</i></button>
                                        <div class="modal fade" id="exampleModalCenter{{ $value->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.value.update', $value) }}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="exampleFormControlInput1">Название UZ</label>
                                                                                <input class="form-control" id="exampleFormControlInput1" required type="text"
                                                                                    name="name_uz" value="{{$value->name_uz}}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="exampleFormControlInput1">Название RU</label>
                                                                                <input class="form-control" id="exampleFormControlInput1" required type="text"
                                                                                    name="name_ru" value="{{$value->name_ru}}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="exampleFormControlInput1">Название EN</label>
                                                                                <input class="form-control" id="exampleFormControlInput1" required type="text"
                                                                                    name="name_en" value="{{$value->name_en}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <label class="form-label">Описание Uz</label>
                                                                            <textarea class="ckeditor" name="discription_uz" id="exampleFormControlTextarea4" rows="3">{{ $value->discription_uz }}</textarea>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <label class="form-label">Описание Ru</label>
                                                                            <textarea class="ckeditor" name="discription_ru" id="exampleFormControlTextarea4" rows="3">{{ $value->discription_ru }}</textarea>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <label class="form-label">Описание En</label>
                                                                            <textarea class="ckeditor" name="discription_en" id="exampleFormControlTextarea4" rows="3">{{ $value->discription_en }}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="alt_uz">Название Файл Uz</label>
                                                                                <input class="form-control" id="alt_uz" type="text" name="alt_uz" value="{{ $value->alt_uz }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="alt_ru">Название Файл Ru</label>
                                                                                <input class="form-control" id="alt_ru" type="text" name="alt_ru" value="{{ $value->alt_ru }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="alt_en">Название Файл En</label>
                                                                                <input class="form-control" id="alt_en" type="text" name="alt_en" value="{{ $value->alt_en }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="photo_discription_uz">Описание Файл Uz</label>
                                                                                <input class="form-control" id="photo_discription_uz" type="text" name="photo_discription_uz" value="{{ $value->photo_discription_uz }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="photo_discription_ru">Описание Файл Ru</label>
                                                                                <input class="form-control" id="photo_discription_ru" type="text" name="photo_discription_ru" value="{{ $value->photo_discription_ru }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="photo_discription_en">Описание Файл En</label>
                                                                                <input class="form-control" id="photo_discription_en" type="text" name="photo_discription_en" value="{{ $value->photo_discription_en }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $value->id }}"><i
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('dashboard.value.destroy', $value->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
